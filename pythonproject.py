...
for i in button_text_list:
    button = Button(root, width=5, height=2, bd=2, relief=SUNKEN, text=i, bg="white",
                    font="aria 18 bold", activebackground="honeydew3", fg="black",
...
Button(root,text="Exit",fg="white",bg="black",font="arial 18 bold",command=exit)
